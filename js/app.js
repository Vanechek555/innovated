(() => {
    ...
    da.init();
    const play = document.querySelector(".community__play");
    const video = document.querySelector(".community__video video");
    play.addEventListener("click", (() => {
        video.play();
        video.setAttribute("controls", "controls");
        play.classList.toggle("community__play_hidden");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
